#!/usr/bin/env python3
"""
Standalone DB init script — runs schema + tier seed outside uvicorn.
...
ON CONFLICT (user_id) DO UPDATE SET role='admin', tier='admin';
"""
...
async def main():
    ...
    try:
        ...
        for t in tiers:
            ...
            print(f"   {t['tier']:12} {t['scans_per_day']:5} scans/day  {t['max_concurrent']} concurrent  {ai}  {prop}")
